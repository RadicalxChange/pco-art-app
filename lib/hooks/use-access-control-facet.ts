    ...
    contracts: [
      {
        ...
        args: [
          keccak256(toHex("AllowlistFacet.COMPONENT_ROLE")),
      ...
      },
      {
        ...
        functionName: "hasRole",
        args: [
          keccak256(toHex("EnglishPeriodicAuctionFacet.COMPONENT_ROLE")),
          accountAddress ?? account.address ?? "0x",
        ],
      },
      {
        ...
        functionName: "hasRole",
        args: [
          keccak256(toHex("IDABeneficiaryFacet.COMPONENT_ROLE")),
          accountAddress ?? account.address ?? "0x",
        ],
      },
      {
        ...
        functionName: "hasRole",
        args: [
          keccak256(toHex("StewardLicenseBase.ADD_TOKEN_TO_COLLECTION_ROLE")),
          accountAddress ?? account.address ?? "0x",
        ],
      },
      {
        ...
        functionName: "hasRole",
        args: [
          keccak256(toHex("PeriodicPCOParamsFacet.COMPONENT_ROLE")),
          accountAddress ?? account.address ?? "0x",
        ],
      },
      {
