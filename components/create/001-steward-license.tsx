...
export default function ConfigStewardLicenseFacet({ nextStep }: { nextStep: () => void }) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="min-w-full rounded-md bg-neutral-100 p-4 dark:bg-neutral-800">
        ...
        <div className="mb-6">
          <label htmlFor="mint-type" className="mb-3 block text-sm font-medium text-gray-900 dark:text-white">
            Mint Type
          </label>
          <input
        ...
        <div className="mb-6">
          <label htmlFor="symbol" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white">
        ...
        <div className="mb-6">
          ...
          <label htmlFor="cycle" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white">
            ...
            , define your token metadata, upload it to NFT.Storage, & add the resulting CID here.
          </label>
          <input
        ...
        <div className="flex items-center justify-center">
          <input type="submit" className="btn bg-gradient-button btn-xl" value="Next"></input>
        </div>
      </div>
    </form>
  )
