...
function updateAction(
  ...
  const licensePeriodInSeconds = fromUnitsToSeconds(pcoSettingsInput.cycle, pcoSettingsInput['cycle-type'])
...
export default function ConfigPCOSettingsFacet({ nextStep, prevStep }: { nextStep: () => void; prevStep: () => void }) {
      ...
      <div className="min-w-full rounded-md bg-neutral-100 p-4 dark:bg-neutral-800">
        ...
        <div className="mb-6">
          ...
          <div className="flex">
            ...
            />
            <select {...register('pco-settings.cycle-type')} className="w-40 rounded-lg border-gray-600 dark:bg-gray-700">
