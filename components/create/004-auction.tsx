...
function updateAction(
  ...
  return {
    ...
    auctionInitData: {
      ...
      initialPeriodStartTime: Date.parse(auctionInput['initial-start-time']) / 1000,
      initialPeriodStartTimeOffset: fromUnitsToSeconds(auctionInput['initial-start-time-offset'], auctionInput['initial-start-time-offset-type']),
      startingBid: ethers.utils.parseEther(auctionInput['starting-bid'].toString()),
      auctionLengthSeconds: fromUnitsToSeconds(auctionInput.duration, auctionInput['duration-type']),
      minBidIncrement: ethers.utils.parseEther(auctionInput['min-bid-increase'].toString()),
...
export default function ConfigAuctionFacet({ nextStep, prevStep }: { nextStep: () => void; prevStep: () => void }) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="min-w-full rounded-md bg-neutral-100 p-4 dark:bg-neutral-800">
        ...
        <div className="mb-6">
          <label htmlFor="auction.initial-start-time" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white">
            Initial Auction
          </label>
          <label htmlFor="auction.initial-start-time" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white">
        ...
        <div className="mb-6">
          <label htmlFor="auction.initial-start-time-offset" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white">
            Collection Offset
          </label>
          <label htmlFor="auction.initial-start-time-offset" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white">
          ...
          <div className="flex">
            ...
            />
            <select {...register('auction.initial-start-time-offset-type')} className="w-40 rounded-lg dark:border-gray-300 dark:bg-gray-700">
        ...
        <div className="mb-6">
          ...
          <div className="flex">
            <input
              ...
              className="mr-5 w-40 rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
            />
            <select {...register('auction.duration-type')} className="dark:brder-gray-300 w-40 rounded-lg dark:bg-gray-700">
              <option value="minutes">Minutes</option>
              <option value="hours">Hours</option>
              <option value="days">Days</option>
              <option value="weeks">Weeks</option>
